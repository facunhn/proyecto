export const CATEGORIES = ['Todos', 'Gastronomía', 'Retail', 'Supermercados', 'Farmacias', 'Bancos'];
...
export const MOCK_PROMOS = [
  ...
  { id: 5, business: 'Urbana Ropa', category: 'Retail', discountLabel: '25% OFF', description: 'En la nueva colección de invierno, todos los locales del país.', expiry: '10/09', distance: '2.1 km', isBank: false, code: 'URB25INV', redeemHint: 'Mostrar código en caja', dLat: -0.0134, dLon: -0.0134 },
  ...
  { id: 9, business: 'MegaHogar', category: 'Retail', discountLabel: '6 cuotas sin interés', description: 'En electrodomésticos de línea blanca, pagando con tarjetas adheridas.', expiry: '25/09', distance: '4.4 km', isBank: false, code: 'MEGA6SI', redeemHint: 'Pagar con tarjeta adherida', dLat: 0.028, dLon: -0.028 },
